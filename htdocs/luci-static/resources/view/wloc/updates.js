...
return view.extend({
    ...
    render: function(data) {
        ...
        function updateButtonState(operation) {
        ...
        function setCheckSetting() {
            ...
            return callSetCheck(desired ? 1 : 0).then(function(result) {
                ...
                wlocUi.setState(status, 'error', wlocUi.errorMessage(error, _('Unable to change automatic check setting.')));
            });
        }
        ...
        return E('div', { 'class': 'cbi-map' }, [
            ...
            E('div', { 'class': 'cbi-section' }, [
                ...
                E('div', { 'class': 'cbi-section-node' }, [
                    ...
                    valueRow(_('Actions'), updateButton),
                    history
                ])
            ])
        ]);
