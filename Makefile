...
LUCI_DEPENDS:=+luci-base +libc +libgcc +nftables +ip-full +jsonfilter +rpcd +rpcd-mod-iwinfo +uhttpd
LUCI_DESCRIPTION:=Selective Apple WLOC TLS proxy with one location rule per access point. Includes wlocd, UCI/procd lifecycle, isolated nftables rules, rpcd and LuCI.
